...
typedef struct
{
    ...
    /**< @brief CTU2 configuration */
    P2CONST(Adc_Ctu2_ConfigType, ADC_VAR, ADC_APPL_CONST) pCtuCfgPtr;
} Adc_ConfigType;
...
/** @violates @ref Adc_cfg_h_REF_3 MISRA 2004 Required Rule 8.7, objects shall be defined at block scope */
extern CONST(Adc_Ctu2_ConfigType, ADC_CONST) Adc_Ctu2ConfigPC;
#else
/** 
* @brief         Declaration Configuration sets.
*/
...
extern CONST(Adc_Ctu2_ConfigType, ADC_CONST) Adc_Ctu2ConfigPB_1;
