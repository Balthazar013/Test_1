...
*/
#define ETIMER_COUNTER_MASK          ((Icu_ValueType)0xFFFF)
/**
@{
*   @brief Implementation specific.
*       Each channel provides a subset of the functionality available in the unified channel,
...
#define IcuChannel_Sbc_Wakeup                     (IcuConf_IcuChannel_IcuChannel_Sbc_Wakeup)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_IcuChannel_Sbc_Wakeup  ((Icu_ChannelType)0U) 
#define IcuChannel_Fan_WPM                     (IcuConf_IcuChannel_IcuChannel_Fan_WPM)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_IcuChannel_Fan_WPM  ((Icu_ChannelType)2U) 
#define IcuChannel_Fan_PPM                     (IcuConf_IcuChannel_IcuChannel_Fan_PPM)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_IcuChannel_Fan_PPM  ((Icu_ChannelType)1U) 
#define IcuChannel_Ble_Spi_Ready                     (IcuConf_IcuChannel_IcuChannel_Ble_Spi_Ready)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_IcuChannel_Ble_Spi_Ready  ((Icu_ChannelType)3U) 
...
*   @{
*/
#define ICU_ETIMER_0_CH_0_ISR_USED 
#define ICU_ETIMER_2_CH_0_ISR_USED 
#define ICU_ETIMER_0_CH_2_ISR_USED 

#define ICU_IRQ_CH_18_ISR_USED 
/**@}*/
/*==================================================================================================
                                             ENUMS
==================================================================================================*/
