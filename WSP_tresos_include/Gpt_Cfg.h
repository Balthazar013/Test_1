...
/**
* @brief Enable API for Dual Mode support.
*/
...
*
*/
#define GPT_OUTPUT_ENABLE_MODE (STD_OFF)
...
#define GPT_ETIMER_USED (STD_OFF)
...
#define GptConf_GptChannelConfiguration_GptChCfg_SwGpt  (0U)
...
#define GPT_PIT_0_CH_1_ISR_USED
/** @} */
...
#define GPT_ETIMER_0_NUM_CHANNEL_U8   (6U)
            
#define GPT_ETIMER_1_NUM_CHANNEL_U8   (6U)
            
#define GPT_ETIMER_2_NUM_CHANNEL_U8   (6U)
            
/* The maximum number of channels in ETIMER */
#define GPT_ETIMER_CHAN_NUM_U8         (24U)

/* The number of modules in ETIMER */
#define GPT_ETIMER_MODULES_NUM_U8      (3U)
        



#define GPT_PIT_0_NUM_CHANNEL_U8   (4U)
...
#define GPT_STM_CHAN_NUM_U8         (4U)

/* The number of modules in STM */
#define GPT_STM_MODULES_NUM_U8      (1U)
        

/**
* @brief The total number of indexes used by the hardware to logic channel map
*/
#define GPT_CHANNEL_IDX_NUM    (GPT_ETIMER_CHAN_NUM_U8 + GPT_PIT_CHAN_NUM_U8 + GPT_STM_CHAN_NUM_U8)
...
#define GPT_ETIMER_MODULE  (GPT_STM_CHAN_NUM_U8 + GPT_PIT_CHAN_NUM_U8) /** @brief index where the ETIMER channels start*/
