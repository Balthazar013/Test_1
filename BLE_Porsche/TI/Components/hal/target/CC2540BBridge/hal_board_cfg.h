...
// Wakeup line output
#define WUP_BV                        BV(0)
#define WUP_SBIT                      P0_0
#define WUP_DDR                       P0DIR
#define WUP_POLARITY                  ACTIVE_HIGH
#define WUP_PORT                      P0SEL
#define HAL_WUP_LINE_ON()             st( WUP_SBIT = WUP_POLARITY (1); )
#define HAL_WUP_LINE_OFF()            st( WUP_SBIT = WUP_POLARITY (0); )
 

// 5V line output
#define D_5V_BV                        BV(0)
#define D_5V_SBIT                      P0_1
//#define 5V_DDR                       P0DIR
#define D_5V_POLARITY                  ACTIVE_HIGH
//#define 5V_PORT                      P0SEL
#define HAL_5V_ON()                  st( D_5V_SBIT = D_5V_POLARITY (1); )
#define HAL_5V_OFF()                 st( D_5V_SBIT = D_5V_POLARITY (0); )

  
// Test RCMB
#define D_TEST_RCMB_BV                 BV(0)
#define D_TEST_RCMB_SBIT               P0_7
//#define 5V_DDR                       P0DIR
#define D_TEST_RCMB_POLARITY           ACTIVE_HIGH
//#define 5V_PORT                      P0SEL
#define HAL_TEST_RCMB_ON()             st( D_TEST_RCMB_SBIT = D_TEST_RCMB_POLARITY (1); )
#define HAL_TEST_RCMB_OFF()            st( D_TEST_RCMB_SBIT = D_TEST_RCMB_POLARITY (0); )

//Err OUT
#define D_CTRL_IDIFF_ERROR_10           P0_3   

 //6mA DC OUT (Bender)
#define D_CTRL_IDIFF_6mA                P0_4

//30mA RMS OUT (Bender)
#define D_CTRL_IDIFF_30mA               P0_5

//PWM OUT (Bender)
#define D_WAKEUPREL_ACTIVE              P0_6


// RED LED
#define D_STATUS_LED_LPCPU_LED          P2_0

// Range externder line
#define PA_EN_BV                        BV(7)
#define PA_EN_SBIT                      P1_7
#define PA_EN_DDR                       P1DIR
#define PA_EN_POLARITY                  ACTIVE_HIGH
#define PA_EN_PORT                      P1SEL
#define ENABLE_PA()                     st( PA_EN_SBIT = PA_EN_POLARITY (1); )
#define DISABLE_PA()                    st( PA_EN_SBIT = PA_EN_POLARITY (0); )
 

#define LNA_EN_BV                       BV(0)
#define LNA_EN_SBIT                     P1_0
#define LNA_EN_DDR                      P1DIR
#define LNA_EN_POLARITY                 ACTIVE_HIGH 
#define LNA_EN_PORT                     P1SEL
#define ENABLE_LNA()                    st( LNA_EN_SBIT = LNA_EN_POLARITY (1); )
#define DISABLE_LNA()                   st( LNA_EN_SBIT = LNA_EN_POLARITY (0); )


#define HGM_EN_BV                       BV(1)
#define HGM_EN_SBIT                     P1_1
#define HGM_EN_DDR                      P1DIR
#define HGM_EN_POLARITY                 ACTIVE_HIGH // 1: High gain Mode, 0: Low gain mode
#define HGM_EN_PORT                     P1SEL
#define ENABLE_HGM()                    st( HGM_EN_SBIT = HGM_EN_POLARITY (1); )
#define DISABLE_HGM()                   st( HGM_EN_SBIT = HGM_EN_POLARITY (0); )
