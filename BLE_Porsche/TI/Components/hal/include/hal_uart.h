...
typedef void (*halUARTCBackTxComplete_t) (void); /* Custom add by PES for the BBridge Project */
...
extern void HalUART_SetTxCompleteCB(halUARTCBackTxComplete_t aCB);  /* Custom add by PES for the BBridge Project */
